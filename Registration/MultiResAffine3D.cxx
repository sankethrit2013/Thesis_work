...
// MultiResoluition registration: Affine, CrossCorrelation, RegularStepGradientDescentOptimizer
...
int main(int argc, char *argv[])
{
	...
	const std::string labelMapInputFile1 = (argc >9) ? argv[9] : "";
	const std::string labelMapOutputFile1 = (argc >10) ? argv[10] : "";
	const std::string labelMapInputFile2 = (argc >11) ? argv[11] : "";
	const std::string labelMapOutputFile2 = (argc >12) ? argv[12] : "";
	const std::string labelMapInputFile3 = (argc >13) ? argv[13] : "";
	const std::string labelMapOutputFile3 = (argc >14) ? argv[14] : "";
	const std::string labelMapInputFile4 = (argc >15) ? argv[15] : "";
	const std::string labelMapOutputFile4 = (argc >16) ? argv[16] : "";
