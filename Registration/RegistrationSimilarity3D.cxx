...
{   
	...
	labelMapReader->SetFileName("C:/Users/zx4403/Dropbox/Research/ITK/ImageVolume/atlasVolume_SV_labelmap_reoriented_RPS.nii");

	ResampleFilterType::Pointer labelMapResampler = ResampleFilterType::New();

	labelMapResampler->SetTransform(finalTransform);
	...
	labelMapResampler->SetOutputDirection(fixedDirection);
	...
	labelMapReader->SetFileName(argv[17]);
	labelMapWriter->SetFileName(argv[18]);
	labelMapWriter->Update();
	//labelMapReader->SetFileName("C:/Users/zx4403/Dropbox/Research/ITK/ImageVolume/atlasVolume_ST_labelmap.nii");
	//writer->SetFileName("C:/Users/zx4403/Dropbox/Research/ITK/ImageVolume/ST_labelmap_registrationOutput.nii");
	//writer->Update();


	//
	// get the difference of moving and fixed image after registration
