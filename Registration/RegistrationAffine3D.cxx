...
int main(int argc, char *argv[])
{
	...
	if (argc < 4)
	{
		...
		std::cerr << "   [stepLength] [maxNumberOfIterations] [translationScale] " << std::endl;
		return EXIT_FAILURE;
	}
	...
	//  Software Guide : BeginLatex
	//
	//a  The transform object is constructed below and is initialized before the registration
	//  process starts.
	//
